...
{
    Die("Invalid Link, link should look something like https://hcrauth.tk/panel/mak/HCR, where mak is the owner of the app, and HCR is the app name.");
}
...
<head>
	<?php
echo '
	    <title>HcRAuth - Login to ' . $username . ' Panel</title>
	    <meta name="og:image" content="https://cdn.discordapp.com/attachments/949344018830098485/971791418106462358/hcrauth.png">
