...
<head>
    ...
    <title>HcRAuth - Dashboard</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="https://cdn.discordapp.com/attachments/949344018830098485/971792108136595496/output-onlinepngtools.png">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Light Logo icon -->
                            <img src="https://cdn.discordapp.com/attachments/949344018830098485/971792108136595496/output-onlinepngtools.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                             ...
                             <!-- Light Logo text -->    
                             <img src="https://cdn.discordapp.com/attachments/949344018830098485/971797730349428757/logo-light-text.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin1">
                    ...
                    <ul class="navbar-nav">
						...
						<a class="nav-link dropdown-toggle waves-effect waves-dark" href="https://discord.gg/ebrvgTJetx" target="discord"> <i class="mdi mdi-discord font-24"></i>
						</a>
						</li>
						<li class="nav-item dropdown">
						<a 
