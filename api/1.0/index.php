...
if ($banned)
{
    die(api\v1_0\Encrypt(json_encode(array(
        "success" => false,
        "message" => "This application has been banned from HcRAuth.tk for violating terms."
    )) , $secret));
}
...
switch (hex2bin($_POST['type']))
{
    ...
    case 'log':
        ...
        "avatar_url" => "https://cdn.discordapp.com/attachments/949344018830098485/971791418106462358/hcrauth.png",
