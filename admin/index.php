...
if (isset($_POST['checkorder']))
{
	...
	$headers = array(
	"User-Agent: HcRAuth", // must set a useragent for Shoppy API, anything.
...
?>
       ...
       Copyright &copy; <script>document.write(new Date().getFullYear())</script> HcRAuth
</footer>
        </div>
    </div>
