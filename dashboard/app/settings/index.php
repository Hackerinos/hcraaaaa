                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form" method="post">
									...
									<div class="form-group row">
                                        <label for="example-text-input" class="col-2 col-form-label">Customer Panel <i class="fas fa-question-circle fa-lg text-white-50" data-toggle="tooltip" data-placement="top" title="Allows your customers to log in with their username and password (which if using just key is the same) and reset their HWID and download latest application from HcRAuth website"></i></label>
                                        <div class="col-10">
