...
if (isset($_POST['register']))
{
    ...
    mysqli_query($link, "INSERT INTO `accounts` (`username`, `email`, `password`, `ownerid`, `role`, `img`,`balance`, `expires`, `registrationip`) VALUES ('$username', '$email', '$pass_encrypted', '$ownerid','tester',' https://cdn.discordapp.com/attachments/949344018830098485/971791418106462358/hcrauth.png','1', NULL, '$ip')") or die(mysqli_error($link));
    ...
    $_SESSION['img'] = 'https://cdn.discordapp.com/attachments/949344018830098485/971791418106462358/hcrauth.png';
    mysqli_close($link);
    header("location: ../dashboard/");
}
